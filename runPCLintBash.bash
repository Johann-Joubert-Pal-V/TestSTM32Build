...
/opt/st/stm32cubeide_1.8.0/stm32cubeide -nosplash --launcher.suppressErrors  -application org.eclipse.cdt.managedbuilder.core.headlessbuild -data . -cleanBuild $1/Debug -E PATH=$PATH -E CC=gcc -E PostBuildCMD="$current_path/SW-PAL-Vtune/SW-PAL-Vtune/postbuild/postbuild.bash $current_path/$1 $1 $2" -markerType cdt
